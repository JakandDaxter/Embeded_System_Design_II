...
proc create_root_design { parentCell } {
  ...
  # Create instance: PWMAXI_1, and set properties
  set PWMAXI_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:PWMAXI:1.0 PWMAXI_1 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins PWMAXI_1/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]

  # Create port connections
  connect_bd_net -net PWMAXI_1_duty [get_bd_pins PWMAXI_1/duty] [get_bd_pins Top_0/DUTY]
  connect_bd_net -net PWMAXI_1_enable [get_bd_pins PWMAXI_1/enable] [get_bd_pins Top_0/en]
  connect_bd_net -net PWMAXI_1_period [get_bd_pins PWMAXI_1/period] [get_bd_pins Top_0/PERIOD]
  connect_bd_net -net Top_0_PWM [get_bd_ports pwm] [get_bd_pins Top_0/PWM]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins PWMAXI_1/s00_axi_aclk] [get_bd_pins Top_0/CLOCK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins PWMAXI_1/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins Top_0/reset] [get_bd_pins util_vector_logic_0/Res]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PWMAXI_1/S00_AXI/S00_AXI_reg] SEG_PWMAXI_1_S00_AXI_reg
